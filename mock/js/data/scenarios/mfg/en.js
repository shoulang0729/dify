...
Object.assign(window.SCENARIOS.mfg, {
  ...
  en3: { template: 'upload',
    ...
    script: {
      ...
      zh: [
        { q: '【上传】询价图纸_K公司_RFQ-2025-118.pdf', a: '从图纸读取形状（L型 195×80）、板厚 t1.5、折弯2处、M6螺纹×2、涂装，在1,240张历史图纸中检出相似前3（见结果表格）。最接近的是现行 SK-3310-A（87%），但**对报价最重要的是第3位 SK-1190**：外形与板厚几乎相同，2023年停产产品的模具 D-092 保管在仓库 T-2。若落料模与筋成形模可改造沿用，有望大幅降低新模具费（估计 RMB 620,000）。※本服务处于构想阶段，相似度为形状特征的机械一致率。' },
