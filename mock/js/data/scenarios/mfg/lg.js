...
Object.assign(window.SCENARIOS.mfg, {
  lg1: { template: 'form',
    ...
    script: {
      ja: [
        { q: '【フォーム送信】日→中／現場向け技術連絡／TN-25-031 原文', a: '社内用語集 v3.4 に揃えて翻訳しました（結果）。注意した点は 2 つ：「治具」は用語集どおり「治具」とし「夹具」を避けました（設備保全課で別物を指すため）。「赤札」は 5S の「红牌」と混同しないよう「红色标签」としています。「技術連絡書」が用語集に未登録なので登録候補に挙げました。' },
      ...
      zh: [
        { q: '【提交表单】日→中／面向现场的技术联络／TN-25-031 原文', a: '已按公司术语表 v3.4 统一翻译（见结果）。注意了2点：「治具」按术语表译为「治具」，避免了「夹具」（设备保全科用于指另一种东西）。「赤札」为避免与5S的「红牌」混淆，译为「红色标签」。「技術連絡書」尚未登记术语表，已列为登记候选。' },
