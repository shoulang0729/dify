...
Object.assign(window.SCENARIOS.mfg, {
  ...
  kn5: { template: 'upload',
    ...
    script: {
      ja: [
        { q: '【アップロード】外貨管理局_通達_2026-31号.pdf、資金管理マニュアル_v4.2.docx', a: '通達 12 ページを読み、自社への影響を 3 件に整理しました（右の結果を参照）。最も影響が大きいのは「資金使途報告の月次化」で、財務課の月次締めに作業が 1 つ増えます。施行は 2026-11-01、初回報告期限は 2026-12-10 です。' },
      ...
      zh: [
        { q: '【上传】外汇管理局_通知_2026-31号.pdf、资金管理手册_v4.2.docx', a: '已读取12页通知，将对本公司的影响整理为3项（见右侧结果）。影响最大的是「资金用途报告改为月度」，财务科月结增加1项工作。施行日 2026-11-01，首次报告截止 2026-12-10。' },
