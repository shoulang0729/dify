...
Object.assign(window.SCENARIOS.mfg, {
  gn1: { template: 'upload',
    ...
    script: {
      ja: [
        { q: '【アップロード】精算申請一覧_2025-08.xlsx、発票画像_2025-08_60件.pdf', a: '60 件を照合しました。**問題なし 49 件・要確認 11 件**です（結果の表。全件は Excel で出力）。差し戻し確定は 3 件：発票の抬頭が個人名（EX-0812）、接待費の上限超過（EX-0819）、事前承認なしの RMB 2,000 超購入（EX-0835）。中村さんの一時帰国航空券は日本円建てで社内レート換算が一致、規程の年 2 回目に到達しています。' },
      ...
      zh: [
        { q: '【上传】报销申请清单_2025-08.xlsx、发票图片_2025-08_60件.pdf', a: '已核对60件。**无问题49件・待确认11件**（见结果表格，全部清单输出为Excel）。确定退回3件：发票抬头为个人（EX-0812）、招待费超标（EX-0819）、无事前批准的超 RMB 2,000 采购（EX-0835）。中村的临时回国机票为日元计价，按公司汇率换算一致，已达规定的每年第2次。' },
