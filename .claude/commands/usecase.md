...
**Notion DB「ユースケース候補」**：https://app.notion.com/p/579945c5e50149a1be639a1035a68004（データソース `collection://d4d18fd5-45ac-4c9e-8136-efbbcfb9bb11`、親ページ「Difyユースケース」）。状態＝`候補` の行が取り込み対象。事実の欄（状態・管理番号・各 URL・取込日）はこのコマンドが書き戻し、判断の欄（PM メモ・統合先・保留）は PM が書く。
