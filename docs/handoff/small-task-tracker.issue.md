...
## PM 判断（2026-09-07 **確定**。D-1〜D-6 すべて推奨どおり。設計書 §9・§11-1）
...
| D-5 | `platform-components.md` PC-01 に GN-06 を足すか | **足す＝ architect が実施済み**（PC-01・PC-11 の「使うサービス」各 1 行。設計書 §11-2）。**この PR の diff に含めない** |
