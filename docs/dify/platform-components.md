...
| 使うサービス | 全サービス。特に KN-03 KN-04（HR 帯）QA-04 DC-07（顧客別・契約）PT-04 PT-05 PT-08 PT-09（個人情報。PT-09 は履歴書を当社側で読むため HR 帯限定・面接官は自分のポストのチェック表だけ） |
...
| 使うサービス | KN-01〜05 QA-01 QA-04 DC-06 DC-07 LG-02 EN-01 EN-03 GN-01 GN-02 GN-03 PT-03 PT-05 PT-06 ＋ QA-05（手書きの巡回票・ヒヤリハット票）KN-12（取扱説明書・作業標準書）NM-06（棚卸差異の表）DC-12（規程・申請の添付）PT-09（履歴書・職務経歴書・添付の写し。**写真の領域は取り込まない**） |
...
| 使うサービス | 全サービス。重点 KN-03 KN-04 GN-01（人事・経費）QA-03 DC-07（顧客・契約）EN-03 NM-01（図面・単価）PT-04 PT-05 PT-08（給与・応募者・受講）PT-09（**強化適用**：履歴書の原文を当社側で読む唯一のサービス。保護属性〔写真・性別・生年月日・民族・婚姻・籍貫など〕の欄を LLM の前で欄ごと削除し、削除した欄の名前だけを `masked_fields` に残す。出口でも保護属性の語・合否の語・給与額を検査。匿名 ID は当社の採用台帳の `C-YY-NNN`＝PT-05 の `C-2609-A` 体系〔エージェント側〕とは別） |
...
| 5 | **PC-03** 文書取込 | 手動アップロード＋メタデータ項目の定義（OCR は W2） | KN DC QA ＋ RS-03 RS-05 CV-03 CV-04 FA-01 FA-03 FA-04 FA-05 EG-01 KN-06 KN-07 KN-08（計 38 件） |
...
| 9 | **PC-13** ファイル出力 | CSV／XLSX（GN-01 GN-02 NM-03） | GN NM QA DC ＋ RS-01 RS-02 RS-03 CV-01 FA-02 DC-09 PO-01〜04（計 43 件） |
| 10 | **PC-11** スケジューラ | NM-03 の日次から | NM-03 KN-05 ＋ RS-01 FA-02 PO-01〜03 DC-08 GN-06（計 18 件） |
| 11 | **PC-14** 通知 | WeCom 群 bot 送信 | QA-03 NM-03 KN-05 ＋ RS-01 PO-01〜03 DC-08 GN-06（計 25 件） |
| 12 | **PC-05** Outline 連携 | 同期ジョブ（読む）→ 下書き（書く） | KN DC LG ＋ RS-02 CV-01 CV-03 CV-04 FA-01 FA-02 FA-03 FA-05 PO-01〜04 EG-01 KN-06〜08 DC-09（計 53 件） |
| 13 | **PC-12** 差分 | `diff-core` Workflow as Tool | EN-01 KN-05 KN-03 ＋ KN-08 EG-01（計 9 件） |
