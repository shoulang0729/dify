...
**この表は 71 件を覆う**（W1 8 ＋ W2 4 ＋ W3 14 ＋ W4 5 ＋ W5 10 ＋ W6 12 ＋ W7 18 ＝ 71。実装リファレンス 72 本のうち**未割り当ては DC-11 の 1 件だけ**で、これは別 Issue で扱う）。成熟度の帯は波をまたがない：W1-W2 ＝ 提供中 12、W3-W5 ＝ 試行版 29、W6-W7 ＝ 構想 30（構想の実装リファレンスは 31 本。差の 1 本が DC-11）。詳細は `docs/handoff/2026-09-08-implementation-order-v2.md` §3-1、QA-05・KN-12・NM-06・DC-12 の割当理由は `docs/handoff/2026-09-21-kintone-derived-usecases.md` §16-1。
...
| W6 構想・既存 PC の範囲（12） | RS-05 KN-07 RS-02 CV-01 CV-03 CV-04 FA-01 FA-03 FA-05 EG-01 **QA-05 NM-06** | 新規 PC なし（PC-03 PC-05 PC-06 PC-12 PC-13 ＋ PC-10 の強化適用）。QA-05 は PC-04 なしで第 1 段が成立（巡回票は PC-03 の OCR）、NM-06 の PC-04 は W5 の NM-04・NM-05 と同じ WMS／ERP アダプタの再利用 |
