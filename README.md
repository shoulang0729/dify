...
| ③ | **ユースケース・シナリオ** | [`docs/dify/usecases`](./docs/dify/usecases/) [`docs/handoff`](./docs/handoff/) [`docs/demo`](./docs/demo/) [`mock/js/data/scenarios`](./mock/js/data/scenarios/) | [`docs/dify/usecases/README.md`](./docs/dify/usecases/README.md) | 77 サービス（実装リファレンスは 67 件）の詳細ユースケース、設計書、デモ進行台本と顧客提示資料（`docs/demo/`）、モックのデモ台本（コードなので `mock/` の下） |
